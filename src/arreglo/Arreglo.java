...
public class Arreglo {
    ...
    */
        ...
        static double total = 0; static int cantidad, cantidadElegida = 0,totalFinal, cantidadFinal; 
    ...
    public static void main(String[] args) {
        ...
        System.out.println("total a pagar: " + totalFinal + " cantidad de productos " + cantidadFinal);
    }
    //funciones
    ...
    public void getAbarrotes(){
                ...
                while(opcion != 10){
                    ...
                    totalFinal+= total;
                    cantidadElegida++;
                    cantidadFinal+=cantidadElegida;
                    System.out.println("Monto a pagar: " + total);
                    System.out.println("cantidad de productos: " + cantidadElegida);
    ...
    public void getPanaderia(){
                ...
                while(opcion != 10){
                    ...
                    cantidadFinal+=cantidadElegida;
                    System.out.println("Monto a pagar: " + total);
                    System.out.println("catidad de producto: " + cantidadElegida);
                    System.out.println("desea algo mas?");
                    System.out.println("si(9)  no (10)");
                    opcion = input.nextInt();
                }
